    ...
    **************************************************************/
    Plugin.prototype = {
        ...
        **********************************************************/
		...
		if(base.$elem.attr("id")=="sliderA") {
            console.log(base.data.currentSlide);

			 if(base.data.currentSlide==1)
			{
				
				if(localStorage.getItem("usernameorchid")!=null && localStorage.getItem("usernameorchid")!='' && localStorage.getItem("passwordorchid")==null && localStorage.getItem("passwordorchid")=='')
				{
				 ...
				 if(localStorage.getItem("usernameorchid")==null || localStorage.getItem("usernameorchid")=='' )
                                   {
